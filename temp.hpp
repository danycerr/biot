...
struct problem_T_descriptor_tri{    
...
struct problem_T_descriptor_quad{    
...
struct problem_T_descriptor_quad_3d{    
...
struct problem_T_descriptor_tetra_3d{    
...
// 	std::string datafilename="resu/lk_hdt_ovp_temp";
	std::string datafilename="resu/ring_pinch_temp2"; 
	int nsubdiv=6; // subdivision of the sqaured mesh
	double diff=0.8e-5;
	double E=1.e-15;
	double poisson =0.3;
